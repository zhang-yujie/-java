...
public class ModuleColumnTypeServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getServletContext().getRequestDispatcher("/admin/moduleColumnTypeList.jsp").forward(request, response);
	}
