		...
		<ul class="layui-nav layui-nav-tree layui-inline" lay-filter="demo"
			...
			<li class="layui-nav-item"><a href="javascript:;">系统设置</a>
				<dl class="layui-nav-child">
					...
					<dd>
						<a href="admin/CourseTypeNavigation.jsp" target="innerFrame">模块管理</a>
					</dd>
					<dd>
					...
					<dd>
						<a href="admin/OperatorTypeServlet"
							target="innerFrame">角色管理</a>
					</dd>
					<dd>
						<a href="" target="innerFrame">默认功能设置</a>
					</dd>
					<dd>
						<a href="" target="innerFrame" >首页信息设置</a>
					</dd>
