...
public class ColumnNameManageServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getServletContext().getRequestDispatcher("/admin/courseTypeNavigation2.jsp").forward(request, response);
	}
