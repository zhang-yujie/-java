...
<body>
	...
	<div>
		<div style="height:300px;width:180px;float:left;margin-right:20px">
			<details> <summary><a href="admin/NewsServlet" target = "innerFrame2">所有栏目</a></summary> <%
		...
		<div>
			<iframe scrolling="yes" src="admin/NewsServlet"
