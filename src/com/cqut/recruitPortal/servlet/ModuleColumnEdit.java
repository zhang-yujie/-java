 ...
 */
public class ModuleColumnEdit extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(isOK){
			...
			String updateSql = "update modulecolumn set `content`=? where columnID=?";
			...
			if(updateCount!=1){
				...
				request.getServletContext().getRequestDispatcher("/admin/ModuleColumnServlet").forward(request, response);
				return;
			}
		}
